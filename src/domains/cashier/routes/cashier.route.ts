...
import { createCashierSchema, deleteCashierSchema, getOneCashierSchema, updateCashierSchema } from "../validations/cashier.validation";
...
router.get("/:id", validateRequest(getOneCashierSchema), getCashierByIdController);
