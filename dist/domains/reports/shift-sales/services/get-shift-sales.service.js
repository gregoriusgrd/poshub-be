...
const getShiftSalesService = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const { start, end, cashierId, status, search, sortBy = "openedAt", order = "desc", } = query;
    // Date filter
    const dateFilter = {};
    if (start || end) {
        dateFilter.openedAt = {};
     ...
     */
    const whereClause = Object.assign(Object.assign(Object.assign(Object.assign({}, dateFilter), (status ? { status } : {})), (cashierId ? { cashierId: Number(cashierId) } : {})), (search
        ? {
            cashier: {
                OR: [
